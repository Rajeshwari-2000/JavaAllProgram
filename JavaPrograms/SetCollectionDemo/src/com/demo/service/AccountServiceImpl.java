...
public class AccountServiceImpl implements AccountService{
	...
	public double checkBalance(String balanceAcid, int balancePin) {

		Account account = findAccountById(balanceAcid);


		if (account != null && account.getPin() == balancePin) {
			return account.getBalance(); 
		} else {
			return -1; 
		}
	}
	private Account findAccountById(String balanceAcid) {
